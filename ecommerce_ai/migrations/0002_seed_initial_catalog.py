...
PRODUCTS = [
    {
        ...
        "description": (
            "Experience music like never before with Quantum Audio Pro. Featuring "
            "next-generation active noise cancellation, adaptive EQ that automatically "
            "tunes to the shape of your ear, and up to 30 hours of battery life."
        ),
        "features": [
    ...
    },
    {
        ...
        "description": (
            "The DevStation X1 is engineered to keep up with demanding workflows. "
            "A fast processor, generous memory, and NVMe storage make development, "
            "creative work, and multitasking feel smooth."
        ),
        "features": [
    ...
    },
    {
        ...
        "description": (
            "The Vision X Content Kit bundles a compact mirrorless camera with "
            "AI-powered autofocus, high-frame-rate video, and stabilization for "
            "travel creators and small studio teams."
        ),
        "features": [
    ...
    },
    {
        ...
        "description": (
            "LifeTracker combines activity tracking, health sensors, GPS, and a "
            "bright AMOLED display in a lightweight case made for daily wear."
        ),
        "features": [
            "7-day battery life",
...
def seed_catalog(apps, schema_editor):
    Category = apps.get_model("ecommerce_ai", "Category")
    Product = apps.get_model("ecommerce_ai", "Product")
